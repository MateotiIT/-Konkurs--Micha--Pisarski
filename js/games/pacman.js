...
window.pacmanStoryShown = window.pacmanStoryShown || false;
...
function showPacmanStory() {
    ...
    ">
      ...
      ">
        <p style="
          ...
          margin-bottom: 15px;
        ">
          🎮 Odkryłeś tajne dokumenty Nintendo!
        </p>
        ...
        <p style="
          ...
          margin-bottom: 15px;
        ">
          😈 Źli managerowie planują<br/>CAŁKOWICIE ZABLOKOWAĆ język polski<br/>we WSZYSTKICH grach na przyszłość!
        </p>
        ...
        <p style="
          ...
          color: var(--white);
        ">
          🏢 Zbierz wszystkie dokumenty, <br/>unikaj agentów ochrony, <br/>i <span style="color: var(--green); font-weight: bold;">OPUBLIKUJ PRAWDĘ W INTERNECIE!</span>
        </p>
      </div>
      ...
      ">
        ...
        <p style="
          ...
          line-height: 1.6;
        ">
          Jeśli cię złapią, sprawa zostanie zatuszowana!<br/>
          Zbierz wszystkie dokumenty i ujawnij skandal!
        </p>
      </div>
      
      <button id="pacman-story-start-btn" style="
  ...
  document
    .getElementById("pacman-story-start-btn")
    .addEventListener("click", () => {
      window.pacmanStoryShown = true;
      startPacmanGame();
    });
}
